...
//        gc.setOutputDir(projectPath + "/src/main/java");
        // E:\ideaProjects\BiShe\qmcc\qmcc-work\src
        gc.setOutputDir("E:\\ideaProjects\\BiShe\\qmcc\\qmcc-work/src/main/java");
        gc.setAuthor("nyc");
...
//        gc.setServiceName("%sService");
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/beshe01?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=UTC");
        // dsc.setSchemaName("public");
        dsc.setDriverName("com.mysql.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("nyc123");
