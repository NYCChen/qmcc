...
public class CacheAspect {
    ...
    private static final String POINTCUT_DEPT_ADD =
            "execution(* com.qmcc.sys.service.impl.DeptServiceImpl.save(..))";
    ...
    // 声明切面表达式
    private static final String POINTCUT_USER_UPDATE = "execution(* com.qmcc.sys.service.impl.UserServiceImpl.updateById(..))";
    private static final String POINTCUT_USER_ADD = "execution(* com.qmcc.sys.service.impl.UserServiceImpl.save(..))";
    private static final String POINTCUT_USER_GET = "execution(* com.qmcc.sys.service.impl.UserServiceImpl.getById(..))";
    private static final String POINTCUT_USER_DELETE = "execution(* com.qmcc.sys.service.impl.UserServiceImpl.removeById(..))";
